...
\begin{itemize}
\item Pertama import library Matplotlib \\
\lstinputlisting[firstline=8,lastline=8]{src/6/1174071/Teori/teori.py}
\item Buat variable array x untuk sumbu x \\
\lstinputlisting[firstline=9,lastline=9]{src/6/1174071/Teori/teori.py}
\item Buat variable array y untuk sumbu y dengan isi yang sama dengan sumbu x \\
\lstinputlisting[firstline=10,lastline=10]{src/6/1174071/Teori/teori.py}
\item Kemudian buat perintah dengan fungsi plot untuk membuat grafik plot \\
\lstinputlisting[firstline=12,lastline=12]{src/6/1174071/Teori/teori.py}
\item Lalu tampilkan plot dengan fungsi show \\
\lstinputlisting[firstline=13,lastline=13]{src/6/1174071/Teori/teori.py}
\end{itemize}

\subsubsection{No 3}
\begin{itemize}
\item Plot adalah grafik yang berupa garis
\lstinputlisting[firstline=8,lastline=13]{src/6/1174071/Teori/teori.py}
\begin{figure}[H]
\centering
...
\lstinputlisting[firstline=15,lastline=20]{src/6/1174071/Teori/teori.py}
\begin{figure}[H]
\centering
...
\lstinputlisting[firstline=22,lastline=27]{src/6/1174071/Teori/teori.py}
\begin{figure}[H]
\centering
...
\lstinputlisting[firstline=29,lastline=34]{src/6/1174071/Teori/teori.py}
\begin{figure}[H]
\centering
...
\lstinputlisting[firstline=37,lastline=47]{src/6/1174071/Teori/teori.py} 
