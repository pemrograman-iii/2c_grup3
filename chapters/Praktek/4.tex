...
\begin{enumerate}
    ...
    \lstinputlisting[firstline=8, lastline=14]{src/4/1174080/Praktek/1174080_csv.py}
	...
	\lstinputlisting[firstline=8, lastline=15]{src/4/1174080/Praktek/main.py}
	
	\item Buat program main2.py yang menggunakan library \verb|NPM_pandas.py| yang membuat dan membaca file csv.

	\lstinputlisting[firstline=8, lastline=12]{src/4/1174080/Praktek/main2.py}
\end{enumerate} 
...
menggunakan gunakan try except untuk menanggulangi error tersebut.
	...
	\lstinputlisting[firstline=7, lastline=16]{src/4/1174080/Praktek/error.py}
