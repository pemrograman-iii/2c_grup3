# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 21:08:22 2019
...
#organisasi =[7,8,6,8,7,9,10]
#perut = [2,3,4,3,2,3,4]
#kuliah =[7,8,7,2,2,6,0]
#hiburan = [8,5,7,8,13,15,25]
  
#plt.plot([],[],color='m', label='organisasi', linewidth=5)
#plt.plot([],[],color='c', label='perut', linewidth=5)
#plt.plot([],[],color='r', label='kuliah', linewidth=5)
#plt.plot([],[],color='k', label='hiburan', linewidth=5)
  
#plt.stackplot(poe, organisasi,perut,kuliah,hiburan, colors=['k','c','r','m'])
...
organisasi =[7,8,6,11,7,8,9]
perut = [2,3,4,3,2,7,5]
kuliah =[7,8,7,2,2,4,2]
hiburan = [8,5,7,8,13,7,15]
slices = [7,2,2,13]
activities = ['organisasi','perut','kuliah','hiburan']
cols = ['c','m','r','b']
